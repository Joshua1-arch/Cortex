...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <div className="mx-auto max-w-[960px] px-4 pb-8 pt-3 sm:px-6 lg:px-8">
        <header className="flex items-center justify-between border border-[#1a1a1a] bg-[#101010] px-4 py-3 shadow-[0_0_0_1px_rgba(90,255,62,0.03)] sm:px-5">
          <div className="text-[22px] font-semibold tracking-[-0.04em] text-[#7cff4d]">Cortex</div>

          <nav className="hidden items-center gap-7 text-[10px] font-medium text-[#cfcfcf] md:flex">
          ...
          <button
            ...
            className="inline-flex min-w-[128px] items-center justify-center rounded-[3px] bg-[#63ff33] px-4 py-2 text-[10px] font-medium text-black transition hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-60"
          >
        ...
        <section className="px-2 pb-14 pt-2 text-center sm:px-10 sm:pt-0">
          <h1 className="mx-auto max-w-[780px] text-[34px] font-semibold uppercase leading-[0.95] tracking-[-0.06em] text-[#e9e9e9] sm:text-[58px] lg:text-[68px]">
            CORTEX: <span className="text-[#64ff32]">AUTONOMOUS INTELLIGENCE</span> MEETS
            DECENTRALIZED FINANCE.
          </h1>

          <p className="mx-auto mt-5 max-w-[640px] text-[12px] leading-6 text-[#d1d1d1] sm:text-[14px]">
            Smarter, faster trading and digital assets, powered by AI agents. Simplifying complexity
            for the next generation of DeFi users.
          </p>

          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              href="/trade"
              className="inline-flex min-w-[186px] items-center justify-center rounded-[6px] bg-[#5bff2f] px-6 py-4 text-[11px] font-medium uppercase tracking-[0.04em] text-black transition hover:brightness-105"
            >
              Get Started On Testnet
            </Link>
            <Link
              href="/nfts"
              className="inline-flex min-w-[186px] items-center justify-center rounded-[6px] bg-[linear-gradient(90deg,#c7ff4f_0%,#f2c94c_100%)] px-6 py-4 text-[11px] font-medium uppercase tracking-[0.04em] text-black transition hover:brightness-105"
            >
        ...
        <section
          id="tokenomics"
          className="mt-8 grid gap-8 bg-[#111111] px-4 py-8 sm:px-6 sm:py-10 lg:grid-cols-[minmax(0,1fr)_340px]"
        >
          <div>
        ...
        <section className="px-2 pb-16 sm:px-0">
          <div className="mx-auto max-w-[620px] rounded-[10px] border border-[#203120] bg-[linear-gradient(180deg,#070b07_0%,#0a0d0a_100%)] px-6 py-10 text-center shadow-[inset_0_0_0_1px_rgba(82,255,105,0.03)] sm:px-10 sm:py-14">
